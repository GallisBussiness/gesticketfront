...
const UpdateUserModal = ({ isOpen, onResolve, onReject,user }) => {
  ...
  return (
    ...
    <div className="mb-3">
            ...
            <input type="text" {...field} className="form-control focus:border-green-700" id="prenom" placeholder="Entrer le prenom" />
             )}/>
            ...
            <input type="text" {...field} className="form-control focus:border-green-700" id="nom" placeholder="Entrer le nom" autoFocus />
             )}/>
            ...
            <input type="email" {...field} className="form-control focus:border-green-700" id="email" placeholder="Entrer l'email" />
             )}/>
